...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { last_login_time: @administrator.last_login_time, name: @administrator.name, password_digest: @administrator.password_digest }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { last_login_time: @administrator.last_login_time, name: @administrator.name, password_digest: @administrator.password_digest }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
