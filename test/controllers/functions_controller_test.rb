...
class FunctionsControllerTest < ActionController::TestCase
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post :create, function: { action: @function.action, controller: @function.controller, description: @function.description, name: @function.name }
    end
  ...
  test "should update function" do
    patch :update, id: @function, function: { action: @function.action, controller: @function.controller, description: @function.description, name: @function.name }
    assert_redirected_to function_path(assigns(:function))
  end
